...
class SmallDecoder(nn.Module):
    ...
    def __init__(self, in_dim=1792, base_ch=64, out_hw=(64,64)):
        ...
        self.up = nn.Sequential(
            ...
            # [MODIFIED] Output 3 channels để khớp với Input
    ...
    def forward(self, h):
        ...
        x_hat = self.up(x)
        # Đảm bảo đúng kích thước output
...
class ConEfficientNet(nn.Module):
    def __init__(self, embedding_dim=1792, feat_dim=128, head='mlp',
                 pretrained=False, use_decoder=True, use_vicreg=True, num_prototypes=1000):
        super().__init__()
